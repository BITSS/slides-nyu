...
# .font90[Sample Timeline for the Production of a Scientific Publication]
...
---
background-image: url("Images/priv_poor.png"), url(Images/priviledge.png), url(Images/pedigree.png)
